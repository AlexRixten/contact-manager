...
export const EditContact = () => {
    ...
    const { mutate } = useMutation(
        (values) => updateContact(contactId, values),
        {
            onSuccess: () => {
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <p className="fst-italic">
                                ...
                                adipisicing elit. Dolores totam incidunt
                                reprehenderit quas ullam consectetur, obcaecati
                                optio modi perspiciatis earum facere dolorem
                                fugit. Veniam sed beatae commodi corporis,
